...
from events.views import event_list,navbar, participants_list, event_details, events_by_category,create_event,update_event, delete_event, create_category, add_participant
